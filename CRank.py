...
class CRank():
	...
	def printKeyphrases(self, nKeyphrases = 10, documentIndex=-1, ):
		if documentIndex == -1:
			...
			for k in range(0, nKeyphrases):
				print('\t' + str(self.keyPhrases[documentIndex][k]))
		else:
